...
public interface RoomController {
	...
	@GetMapping("/roomByFloorAndBuilding")
	List<RoomDTO> findRoomsByFloorNameAndBuildingName(@Param("floorName") String floorName, @Param("buildingName") String buildingName);
}
